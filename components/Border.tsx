...
export function Border() {
  ...
  return (
    <>
      ...
      <div className={cn(open ? "border-b" : "border-none -translate-y-[15px]", "absolute inset-x-3 top-0 z-10 box-content h-3.5 overflow-hidden border-border bg-gradient-noise-top backdrop-blur-md transition-[transform,border] ease-snappy")}>
